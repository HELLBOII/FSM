...
/**
 * Admin flow: same as JobExecution but used when navigating from AdminJobDetails.
 * Back goes to AdminJobDetails; on submit success goes to AdminTechnicianJobs.
 */
export default function AdminJobExecution() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      {/* Header */}
      <div className="shrink-0 bg-white border-b px-4 py-3 z-30">
        <div data-source-location="pages/JobExecution:269:8" data-dynamic-content="true" className="flex items-center gap-3">
          <Button data-source-location="pages/JobExecution:270:10" data-dynamic-content="false" variant="ghost" size="icon" onClick={() => navigate(createPageUrl('AdminJobDetails') + `?id=${jobId}`)}>
      ...
      {/* Progress Bar */}
      <div className="shrink-0 px-4 py-3 bg-gray-50 border-b">
      ...
      {/* Section Navigation - tabs; only tab content scrolls */}
      <div className="shrink-0 flex border-b bg-white z-20">
      ...
      <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
        {/* Tasks Section: scrollable list + Add Task fixed at bottom */}
        {activeSection === 'tasks' &&
        <motion.div
        ...
        >
          {/* Scrollable task list with defined height */}
          <div className="flex-1 min-h-0 overflow-auto p-4 space-y-3 pb-4">
                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className={`font-medium ${task.completed ? 'text-emerald-700 line-through' : 'text-gray-900'}`}>
                        {task.task}
                      </p>
                    </div>
                    {task.completed && (
          ...
          {/* Add Task button fixed at bottom of Tasks tab */}
        ...
        {/* Photos / Readings / Notes: scrollable content when active */}
        {(activeSection === 'photos' || activeSection === 'readings' || activeSection === 'notes') && (
      ...
      {/* Complete & Submit Report - fixed bar below tabs (like progress/tab section) */}
